...
public class Leave_Approver_Rejected extends launchezhour{

//	leave apply --> 1 level rejected
//  leave apply --> 1 level approved  and 2 second level rejected
	
	
	   @Test
		public void Leave_apply_for_firstlevel_rejected_scenarieo() throws InterruptedException
		{
	...
	Tenant_object tenant_choose=new Tenant_object(driver);
	   ...
	   @Test(enabled = true)
	   public void first_leave_approval_second_leavel_rejected() throws InterruptedException
	   {
		  Thread.sleep(2000);
