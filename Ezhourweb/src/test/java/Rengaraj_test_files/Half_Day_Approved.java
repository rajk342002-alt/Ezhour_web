...
public class Half_Day_Approved extends launchezhour{

//  Half day leave approved	
//	Half day  approved leave cancellation
// Half day cancellation pending approved
	
	
	
	
	@Test()
	public void Half_day_apply_leave_then_two_leavel_approved() throws InterruptedException
	{
		//tenant choosing
Tenant_object tenant_choose=new Tenant_object(driver);
		...
		leaveapply.From_date_select(proporty.getProperty("Halfday_fromdate"));
		leaveapply.To_date_click();
		leaveapply.To_date_select(proporty.getProperty("Halfday_todate"));
		halfday.halfday(1);
	...
	@Test(dependsOnMethods = "Half_day_apply_leave_then_two_leavel_approved")
	public void Half_day_Approved_Leave_cancellation() throws InterruptedException
	{
	...
	@Test(dependsOnMethods = "Half_day_Approved_Leave_cancellation")
	public void TL_Approved_Half_day_leave_cancellation_approved() throws InterruptedException
	{
		Thread.sleep(1000);
		Logout_object loguout=new Logout_object(driver);
		loguout.click_username();
	...
	@Test(dependsOnMethods = "TL_Approved_Half_day_leave_cancellation_approved")
	public void Manager_Approved_Half_day_leave_cancellation_approved() throws InterruptedException
	{
		Thread.sleep(2000);
