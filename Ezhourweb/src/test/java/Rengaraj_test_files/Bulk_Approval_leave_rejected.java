...
public class Bulk_Approval_leave_rejected extends launchezhour {

	@Test
	public void Apply_leave_In_Bulk_approval_rejected() throws InterruptedException
	{
...
//		todate++;
	...
	@Test(dependsOnMethods = "Apply_leave_In_Bulk_approval_rejected")
...
Myapproval_multiselect_object multiselect=new Myapproval_multiselect_object(driver);
		...
		multiselect.multiselect_reject_button_click();
		Thread.sleep(2000);
		multiselect.rejected_sucess_message();
