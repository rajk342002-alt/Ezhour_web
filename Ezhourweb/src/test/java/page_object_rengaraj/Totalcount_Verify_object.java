...
public class Totalcount_Verify_object extends comman_methods{

	WebDriver driver;
	
	public Totalcount_Verify_object(WebDriver driver)
	{
		super(driver);
	...
	@FindBy(xpath = "//*[@id=\"kt_app_main\"]/div/leaves/div/div/div/div/div[2]/div/div/p-paginator/div/p-dropdown/div")
...
//		String totalname=split[0];
//		int count_number=Integer.parseInt(split[1]);
//		System.out.println("Total count: "+count_number);
	}
